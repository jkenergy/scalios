 ...
 * 
 * $LastChangedDate: 2008-03-21 19:56:39 +0000 (Fri, 21 Mar 2008) $
 * $LastChangedRevision: 682 $
 * $LastChangedBy: kentindell $
 * $HeadURL: http://10.211.55.3/svn/repos/ertcs/rtos/trunk/embedded/src/OS/kernel/osappkernel.h $
 * 
 * Target CPU: 		Generic
...
struct os_queuecb_dyn {
	 ...
	 */
	TaskType *head;									/* Points to the head of the corresponding FIFO priority queue */
...
extern AppModeType NEAR(os_appmode);				/* Current application mode of the system */

extern const struct os_appmodecb const os_appmodes[];	/* Application mode control block instances */
...
extern const struct os_flags const os_init_flags;
