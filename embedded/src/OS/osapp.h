 ...
 * 
 * $LastChangedDate: 2008-03-01 00:27:30 +0000 (Sat, 01 Mar 2008) $
 * $LastChangedRevision: 631 $
 * $LastChangedBy: kentindell $
 * $HeadURL: http://10.211.55.3/svn/repos/ertcs/rtos/trunk/embedded/src/OS/osapp.h $
 * 
 * Target CPU:		Generic
...
#undef GetCounterValue
#define GetCounterValue(c, v)			(os_GetCounterValue(c, v), E_OK)

#undef GetElapsedCounterValue
#define GetElapsedCounterValue(c, v, e)	(os_GetCounterValue(c, v, e), E_OK)
