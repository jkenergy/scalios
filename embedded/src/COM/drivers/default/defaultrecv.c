 ...
 * $HeadURL: http://10.211.55.3/svn/repos/ertcs/rtos/trunk/embedded/src/COM/drivers/default/defaultrecv.c $
 * 
 * Target CPU: 		Generic
 ...
 */
StatusType com_driver_default_recv(com_receiverh receiver, ApplicationDataRef dest)
{
